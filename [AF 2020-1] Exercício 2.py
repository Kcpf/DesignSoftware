...
Números completos (13 ou 14 caracteres), incluindo o código do país (+55) e o código de área (ex: 11). Exemplos: '+5511912345678' ou '+551133334444' (note que ambos começam com o caractere '+');
Número contendo apenas o código de área (10 ou 11 caracteres). Exemplos: '11987654321' ou '1155556666';
Número sem código de área (8 ou 9 caracteres). Exemplos: '918273645' ou '77778888'.
...
def lista_celulares(lista_numeros):
    ...
    for each in lista_numeros:
        if len(each) == 14:
            lista_cel.append(each[5:])
        elif len(each) == 11:
            lista_cel.append(each[2:])
        elif len(each) == 9:
            lista_cel.append(each)
    return lista_cel